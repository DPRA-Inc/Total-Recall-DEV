...
#Region " Public Methods "
        ...
        Public Shared Function CnvJsonDataToList(jsondata As JObject) As List(Of AdverseDeviceEvent)
            ...
            For Each obj In jsondata.GetValue("results")
                ...
                With tmp
                    .AdverseEventFlag = CStr(obj("adverse_event_flag"))
                    .ProductProblemFlag = CStr(obj("product_problem_flag"))
                    .DateOfEvent = CStr(obj("date_of_event"))
                    .DateReport = CStr(obj("date_report"))
                    .DateReceived = CStr(obj("date_received"))
                    .NumberDevicesInEvent = CStr(obj("number_devices_in_event"))
                    .NumberPatientsInEvent = CStr(obj("number_patients_in_event"))
                    'Source
                    .ReportSourceCode = CStr(obj("report_source_code"))
                    .HealthProfessional = CStr(obj("health_professional"))
                    .ReporterOccupationCode = CStr(obj("reporter_occupation_code"))
                    .InitialReportToFda = CStr(obj("initial_report_to_fda"))
                    .ReprocessedAndReusedFlag = CStr(obj("reprocessed_and_reused_flag"))

                    For Each itm In obj("type_of_report")
                        .TypeOfReport.Add(CStr(itm))
                    Next

                    .DateFacilityAware = CStr(obj("date_facility_aware"))
                    .ReportDate = CStr(obj("report_date"))
                    .ReportToFda = CStr(obj("report_to_fda"))
                    .DateReportToFda = CStr(obj("date_report_to_fda"))
                    .ReportToManufacturer = CStr(obj("report_to_manufacturer"))
                    .DateReportToManufacturer = CStr(obj("date_report_to_manufacturer"))
                    .EventLocation = CStr(obj("event_location"))

                    .DistributorName = CStr(obj("distributor_name"))
                    .DistributorAddress1 = CStr(obj("distributor_address_1"))
                    .DistributorAddress2 = CStr(obj("distributor_address_2"))
                    .DistributorCity = CStr(obj("distributor_city"))
                    .DistributorState = CStr(obj("distributor_state"))
                    .DistributorZipCode = CStr(obj("distributor_zip_code"))
                    .DistributorZipCodeExt = CStr(obj("distributor_zip_code_ext"))

                    .ManufacturerName = CStr(obj("manufacturer_name"))
                    .ManufacturerAddress1 = CStr(obj("manufacturer_address_1"))
                    .ManufacturerAddress2 = CStr(obj("manufacturer_address_2"))
                    .ManufacturerCity = CStr(obj("manufacturer_city"))
                    .ManufacturerState = CStr(obj("manufacturer_state"))
                    .ManufacturerZipCode = CStr(obj("manufacturer_zip_code"))
                    .ManufacturerZipCodeExt = CStr(obj("manufacturer_zip_code_ext"))
                    .ManufacturerCountry = CStr(obj("manufacturer_country"))
                    .ManufacturerPostalCode = CStr(obj("manufacturer_postal_code"))

                    .EventType = CStr(obj("event_type"))
                    .DeviceDateOfManufacture = CStr(obj("device_date_of_manufacture"))
                    .SingleUseFlag = CStr(obj("single_use_flag"))
                    .PreviousUseCode = CStr(obj("previous_use_code"))

                    For Each itm In obj("remedial_action")
                        .RemedialAction.Add(CStr(itm))
                    Next
                    .RemovalCorrectionNumber = CStr(obj("removal_correction_number"))

                    .ManufactureContactNameTitle = CStr(obj("manufacturer_contact_t_name"))
                    .ManufactureContactNameFirst = CStr(obj("manufacturer_contact_f_name"))
                    .ManufactureContactNameLast = CStr(obj("manufacturer_contact_l_name"))

                    .ManufactureContactStreet1 = CStr(obj("manufacturer_contact_street_1"))
                    .ManufactureContactStreet2 = CStr(obj("manufacturer_contact_street_2"))
                    .ManufactureContactCity = CStr(obj("manufacturer_contact_city"))
                    .ManufactureContactState = CStr(obj("manufacturer_contact_state"))
                    .ManufactureContactZipCode = CStr(obj("manufacturer_contact_zip_code"))
                    .ManufactureContactZipCodeExt = CStr(obj("manufacturer_contact_zip_ext"))
                    .ManufactureContactPostal = CStr(obj("manufacturer_contact_postal"))
                    .ManufactureContactCountry = CStr(obj("manufacturer_contact_country"))

                    .ManufactureContactPhoneCountry = CStr(obj("manufacturer_contact_pcountry"))
                    .ManufactureContactPhoneAreaCode = CStr(obj("manufacturer_contact_area_code"))
                    .ManufactureContactPhoneExchange = CStr(obj("manufacturer_contact_exchange"))
                    .ManufactureContactPhoneExtension = CStr(obj("manufacturer_contact_extension"))
                    .ManufactureContactPhoneCity = CStr(obj("manufacturer_contact_pcity"))
                    .ManufactureContactPhoneNumber = CStr(obj("manufacturer_contact_phone_number"))
                    .ManufactureContactLocal = CStr(obj("manufacturer_contact_plocal"))

                    .ManufactureName = CStr(obj("manufacturer_g1_name"))
                    .ManufactureStreet1 = CStr(obj("manufacturer_g1_street_1"))
                    .ManufactureStreet2 = CStr(obj("manufacturer_g1_street_2"))
                    .ManufactureCity = CStr(obj("manufacturer_g1_city"))
                    .ManufactureState = CStr(obj("manufacturer_g1_state"))
                    .ManufactureZipCode = CStr(obj("manufacturer_g1_zip_code"))
                    .ManufactureZipCodeExt = CStr(obj("manufacturer_g1_zip_ext"))
                    .ManufacturePostalCode = CStr(obj("manufacturer_g1_postal_code"))
                    .ManufactureCountry = CStr(obj("manufacturer_g1_country"))

                    .DateManufacturerReceived = CStr(obj("date_manufacturer_received"))

                    For Each itm In obj("source_type")
                        .SourceType.Add(CStr(itm))
                    Next

                    .EventKey = CStr(obj("event_key"))
                    .MdrReportKey = CStr(obj("mdr_report_key"))
                    .ManufacturerLinkFlag = CStr(obj("manufacturer_link_flag_"))

                    .Device = DeviceEventDeviceData.CnvJsonDataToList(CType(obj("device"), JArray))
                    .Patient = DeviceEventPatientData.CnvJsonDataToList(CType(obj("patient"), JArray))
                    .MdrText = DeviceEventMdrTextData.CnvJsonDataToList(CType(obj("mdr_text"), JArray))
